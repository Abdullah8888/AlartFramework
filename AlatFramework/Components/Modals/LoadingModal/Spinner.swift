...
//  AlatFramework
//
//  Created by Adjogbe  Tejiri on 09/02/2023.
//
...
@IBDesignable class Spinner: UIView {
    ...
    func setup() {
        ...
        pathLayer.strokeColor = UIColor.alatRed.withAlphaComponent(0.3).cgColor
        ...
        circleLayer.strokeColor = UIColor.alatRed.cgColor
